...
private:
	...
	int							m_mouse_info[3]; // Mouse ������ ��� ���� integer array.
...
public:
	...
	enum E_EXCLUSIVE // debugging �� ���� ���ؼ�...
	{
		EXCLUSIVE,
		NONEXCLUSIVE,
	};

	enum E_MOUSE_EVENT // MOUSE_EVENT�� wincon.h�� ���� �Ǿ� ����! ~.~
	{
		MOVE = 0,
		LEFTDOWN,
		LEFTUP,
...
private:
	...
	int							m_limit_x; // mouse �̵� ����
	int							m_limit_y; // mouse �̵� ����
