...
{	
	...
	// append화일 체크..
	//-------------------------------------------------------------
	ifstream appendFile(appendFilename.GetString(), ios::binary | ios::nocreate);		
...
{
	ifstream file(currentFilename, ios::binary | ios::nocreate);
...
{
	ifstream orgFile(m_orgFilename.GetString(), ios::binary | ios::nocreate);
