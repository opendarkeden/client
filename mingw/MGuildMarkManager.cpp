...
MGuildMarkManager::LoadGuildMark(WORD guildID)
{
	...
	if (iMapper!=g_pGuildInfoMapper->end())
	{
		...
		ifstream spkFile(m_GuildMarkSPKFilename.GetString(), ios::binary | ios::nocreate);
		ifstream spkiFile(spkiFilename, ios::binary | ios::nocreate);
...
MGuildMarkManager::SaveGuildMark(WORD guildID, CSprite* pSprite, CSprite* pSpriteSmall)
{
		...
		&& pSpriteSmall!=NULL)
	{
		...
		// index도 추가해야 한다.
		//---------------------------------------------------------
		ifstream spkInputFile(m_GuildMarkSPKFilename.GetString(), ios::binary | ios::nocreate);
		...
		ofstream spkFile(m_GuildMarkSPKFilename.GetString(), ios::binary | ios::ate);
		ofstream spkiFile(spkiFilename, ios::binary | ios::ate);
...
//				pInfo->SetLeaderName("Leader");				
			...
			ofstream file(m_GuildMarkSpriteMapperFilename.GetString(), ios::binary);
									...
									const char* pIDMapperFilenameApp)
{
		...
		//---------------------------------------------------------
		ifstream spkInputFile(pSPKFilenameOrg, ios::binary | ios::nocreate);
		ifstream spkInputFileApp(pSPKFilenameApp, ios::binary | ios::nocreate);
		ifstream spkiInputFileApp(pSPKIFilenameApp, ios::binary | ios::nocreate);
		...
		//-----------------------------------------------------------------------------
		ofstream spkiFileOrg(pSPKIFilenameOrg, ios::binary | ios::ate);
		ifstream spkiFileApp(pSPKIFilenameApp, ios::binary | ios::nocreate);
		...
		ifstream mapperFileOrg(pIDMapperFilenameOrg, ios::binary | ios::nocreate);
		ifstream mapperFileApp(pIDMapperFilenameApp, ios::binary | ios::nocreate);
		...
		// MapperOrg를 다시 저장한다.
		ofstream mapperOutputFileOrg(pIDMapperFilenameOrg, ios::binary);
