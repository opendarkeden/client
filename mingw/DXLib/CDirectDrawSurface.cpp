...
//----------------------------------------------------------------------
#define GAMMA_MASK565_1PIXEL1				0b00000000000000001111100000011111
#define GAMMA_MASK565_1PIXEL2				0b00000000000000000000011111100000
#define GAMMA_MASK565_2PIXEL1				0b11111000000111110000011111100000
#define GAMMA_MASK565_2PIXEL2				0b00000111111000001111100000011111
#define GAMMA_MASK565_4PIXEL_R				0b11111000000000001111100000000000
#define GAMMA_MASK565_4PIXEL_G				0b00000111111000000000011111100000
#define GAMMA_MASK565_4PIXEL_B				0b00000000000111110000000000011111

#define GAMMA_MASK555_1PIXEL1				0b00000000000000000111110000011111
#define GAMMA_MASK555_1PIXEL2				0b00000000000000000000001111100000
#define GAMMA_MASK555_2PIXEL1				0b01111100000111110000001111100000
#define GAMMA_MASK555_2PIXEL2				0b00000011111000000111110000011111
#define GAMMA_MASK555_4PIXEL_R				0b01111100000000000111110000000000
#define GAMMA_MASK555_4PIXEL_G				0b00000011111000000000001111100000
#define GAMMA_MASK555_4PIXEL_B				0b00000000000111110000000000011111
...
void CDirectDrawSurface::Gamma4Pixel565(void *pDest, int len, int p)
{
    ...
    //     "punpcklwd %%mm0, %%mm0\n\t"
    //     "punpckldq %%mm0, %%mm0\n\t"
    //     "movd %%mm1, %[MASK_4PIXEL_R]\n\t"
    //     "movd %%mm2, %[MASK_4PIXEL_G]\n\t"
    //     "movd %%mm3, %[MASK_4PIXEL_B]\n\t"
    //     "punpckldq %%mm1, %%mm1\n\t"
    //     "punpckldq %%mm2, %%mm2\n\t"
    //     "punpckldq %%mm3, %%mm3\n\t"
    // "4:\n\t"
    ...
    //     "emms"
    //     :
    //     : [pDest] "r" (pDest), [len] "r" (len), [p] "r" (p),
    //       [MASK_1PIXEL1] "r" (GAMMA_MASK565_1PIXEL1),
    //       [MASK_1PIXEL2] "r" (GAMMA_MASK565_1PIXEL2),
    //       [MASK_2PIXEL1] "r" (GAMMA_MASK565_2PIXEL1),
    //       [MASK_2PIXEL2] "r" (GAMMA_MASK565_2PIXEL2),
    //       [MASK_4PIXEL_R] "r" (GAMMA_MASK565_4PIXEL_R),
    //       [MASK_4PIXEL_G] "r" (GAMMA_MASK565_4PIXEL_G),
    //       [MASK_4PIXEL_B] "r" (GAMMA_MASK565_4PIXEL_B)
    //     : "eax", "ebx", "ecx", "edx", "edi", "mm0", "mm1", "mm2", "mm3", "mm4", "mm5", "mm6", "memory"
    // );
}
...
void CDirectDrawSurface::Gamma4Pixel555(void *pDest, int len, int p)
{
    ...
    //     "emms\n"
    //     : "=r"(pDest), "=r"(len), "=r"(p)
    //     : "m"(GAMMA_MASK555_1PIXEL1), "m"(GAMMA_MASK555_1PIXEL2),
    //       "m"(GAMMA_MASK555_2PIXEL1), "m"(GAMMA_MASK555_2PIXEL2),
    //       "m"(GAMMA_MASK555_4PIXEL_R), "m"(GAMMA_MASK555_4PIXEL_G), "m"(GAMMA_MASK555_4PIXEL_B)
    //     : "memory", "cc", "eax", "ebx", "ecx", "edx", "edi", "mm0", "mm1", "mm2", "mm3", "mm4", "mm5", "mm6"
    // );
}
...
CDirectDrawSurface::ShowFPS(int x, int y, COLORREF fcolor, COLORREF bcolor)
{
	...
	thisTickTime = GetTickCount();
		if (abs(int(thisTickTime - oldTickTime)) >= 1000)
		  {
		    fps = frame;
		    frame = 0;
