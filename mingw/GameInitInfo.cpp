...
//	SAFE_DELETE( g_pAddonSpriteTable );
	...
	if (g_pGuildInfoMapper==NULL)
	{
		...
		// 이 화일은 없을 수도 있다.
		ifstream guildInfoFile(g_pFileDef->getProperty("FILE_INFO_GUILD_INFO_MAPPER").c_str(), ios::binary | ios::nocreate);
...
//	}
	...
	ifstream chatInfoFile2;//(g_pFileDef->getProperty("FILE_INFO_USINGCOLORSET").c_str(), ios::binary);
...
//	ifstream helpManagerFile;//(g_pFileDef->getProperty("FILE_INFO_USINGCOLORSET").c_str(), ios::binary);
...
//	helpManagerFile.close();
	...
	ifstream helpStringTableFile;//(g_pFileDef->getProperty("FILE_INFO_USINGCOLORSET").c_str(), ios::binary);
	...
	ifstream levelNameTableFile;//(g_pFileDef->getProperty("FILE_INFO_USINGCOLORSET").c_str(), ios::binary);
	...
	ifstream MonsterNameTableFile;//(g_pFileDef->getProperty("FILE_INFO_USINGCOLORSET").c_str(), ios::binary);
	...
	/*
		...
		// Save
		//------------------------------------------------
		ofstream usingColorSetTable(g_pFileDef->getProperty("FILE_INFO_USINGCOLORSET").c_str(), ios::binary);
	...
	*/
	...
	ifstream usingColorSetTable2;//(g_pFileDef->getProperty("FILE_INFO_USINGCOLORSET").c_str(), ios::binary);
	...
	ifstream soundTable2;//(g_pFileDef->getProperty("FILE_INFO_SOUND").c_str(), ios::binary);
	...
	ifstream musicTable2;//(g_pFileDef->getProperty("FILE_INFO_MUSIC").c_str(), ios::binary);
	...
	ifstream zoneTable2;//(g_pFileDef->getProperty("FILE_INFO_ZONE").c_str(), ios::binary);
	...
	ifstream itemTable2;//(g_pFileDef->getProperty("FILE_INFO_ITEM").c_str(), ios::binary);
	...
	ifstream itemOptionTable2(g_pFileDef->getProperty("FILE_INFO_ITEMOPTION").c_str(), ios::binary);
	...
	ofstream itemOptionTable(g_pFileDef->getProperty("FILE_INFO_ITEMOPTION").c_str(), ios::binary);
	...
	*/
	...
	// Save
	//------------------------------------------------
	ofstream interactionObjectTable(g_pFileDef->getProperty("FILE_INFO_INTERACTIONOBJECT"), ios::binary);
	...
	*/
	...
	ifstream interactionObjectTable2;//(g_pFileDef->getProperty("FILE_INFO_INTERACTIONOBJECT"), ios::binary);
	...
	// Load
	//------------------------------------------------
	ifstream creatureSpriteTable2;//(g_pFileDef->getProperty("FILE_INFO_CREATURE"), ios::binary);
	...
	// Addon SpriteTable
	//------------------------------------------------
//	ifstream addonSpriteTable2;//(g_pFileDef->getProperty("FILE_INFO_CREATURE"), ios::binary);
...
//	ifstream creatureActionSpriteTable2;//(g_pFileDef->getProperty("FILE_INFO_CREATURE"), ios::binary);
...
//	creatureActionSpriteTable2.close();
	...
	ifstream creatureTable2;//(g_pFileDef->getProperty("FILE_INFO_CREATURE"), ios::binary);
	...
	ifstream CreatureSpriteTypeMapper2;//(g_pFileDef->getProperty("FILE_INFO_CREATURE"), ios::binary);
	...
	ifstream ShopTemplateTable2;//(g_pFileDef->getProperty("FILE_INFO_SHOPTEMPLATE"), ios::binary);
	...
	ifstream NPCTable2;//(g_pFileDef->getProperty("FILE_INFO_CREATURE"), ios::binary);
	...
	ifstream NPCScriptTable;//(g_pFileDef->getProperty("FILE_INFO_CREATURE"), ios::binary);
	...
	ifstream effectSpriteTypeTable2;//(g_pFileDef->getProperty("FILE_INFO_EFFECTSPRITETYPE"), ios::binary);
	...
	// Load
	//------------------------------------------------
	ifstream actionEffectSpriteTypeTable2;//(g_pFileDef->getProperty("FILE_INFO_EFFECTSPRITETYPE"), ios::binary);
	...
	ifstream EffectStatusTable2;//(g_pFileDef->getProperty("FILE_INFO_EffectStatus"), ios::binary);
	...
	ifstream skillTable2;//(g_pFileDef->getProperty("FILE_INFO_skill"), ios::binary);
	...
	ifstream serverSkillInfoFile;//(g_pFileDef->getProperty("FILE_INFO_skill"), ios::binary);
	...
	ifstream rankBonusInfoFile;//(g_pFileDef->getProperty("FILE_INFO_skill"), ios::binary);
	...
	ifstream actionInfoFile2;//(g_pFileDef->getProperty("FILE_INFO_ACTION"), ios::binary);
