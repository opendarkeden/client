...
//		}		
	...
	if (CDirect3D::IsHAL())
	{
		...
		//
		//------------------------------------------------------------
		ifstream	effectFile2(FILE_ASPRITE_ALPHAEFFECT, ios::binary);
...
MTopView::InitSprites()
{
	...
	*/
	...
	//------------------------------------------------------------
	ofstream	ImageObjectSFile(FILE_SSPRITE_IMAGEOBJECT, ios::binary);	
	ofstream	ImageObjectSIndexFile(FILE_SSPRITEINDEX_IMAGEOBJECT, ios::binary);	
	...
	*/
	...
	/*
	ifstream	ImageObjectShadowFile2;//(FILE_SSPRITE_IMAGEOBJECT, ios::binary);
...
//	DrawTitleLoading();
	...
	if (m_CreatureSPK.GetSize()==0)
	{
		/*
		WORD size;
		ifstream CreaturePackIndexFile;//(FILE_ISPRITEINDEX_CREATURE, ios::binary);
...
//	DrawTitleLoading();
	...
	//------------------------------------------------------------
	ofstream	creatureShadowFile(FILE_SSPRITE_CREATURE, ios::binary);	
	ofstream	creatureShadowIndexFile(FILE_SSPRITEINDEX_CREATURE, ios::binary);
	...
	*/
	...
	ifstream	CreatureShadowFile2;//(FILE_ISPRITE_ADDON, ios::binary);
	...
	*/
	...
	// 전체 개수만 잡아둔다.
	/*
	ifstream CreatureShadowPackIndexFile;//(FILE_ISPRITEINDEX_CREATURE, ios::binary);
	...
	*/
	...
	// 임시로 Load
	// 전체 loading해두는 부분
	ifstream	CreatureShadowFile2;//(FILE_SSPRITE_Creature, ios::binary);
...
//	DrawTitleLoading();
	...
	//------------------------------------------------------------
	ofstream	clothesFile("Clothes.spk", ios::binary);	
	ofstream	clothesIndexFile("Clothes.spki", ios::binary);	
...
/*	
	...
	{
		ifstream	AddonFile2;//(FILE_ISPRITE_ADDON, ios::binary);
...
*/
	...
	// 남
	/*
	ifstream	AddonMaleShadowFile2;//(FILE_ISPRITE_ADDON, ios::binary);
	...
	*/
	...
	// 남 - Save  ShadowSpritePack	
	//------------------------------------------------------------
	ofstream	AddonMaleShadowFile(FILE_SSPRITE_ADDON_MALE, ios::binary);	
	ofstream	AddonMaleShadowIndexFile(FILE_SSPRITEINDEX_ADDON_MALE, ios::binary);	
	...
	*/
	...
	// Male
	/*
	ifstream	AddonShadowFile2;//(FILE_ISPRITE_ADDON, ios::binary);
...
//	DrawTitleLoading();
	...
	//------------------------------------------------------------
	ofstream	itemTileFile(FILE_SPRITE_ITEMTILE, ios::binary);	
	ofstream	itemTileIndexFile(FILE_SPRITEINDEX_ITEMTILE, ios::binary);	
	...
	*/
	...
	{
//		ifstream	itemTileFile2;//(FILE_SPRITE_ITEMTILE, ios::binary);
...
//		itemTileFile2.close();
	...
	{
//		ifstream	itemDropFile2;//(FILE_SPRITE_itemDrop, ios::binary);
...
//		itemDropFile2.close();
	...
	{
//		ifstream	itemBrokenFile2;//(FILE_SPRITE_itemBroken, ios::binary);
...
//	DrawTitleLoading();
	...
	//------------------------------------------------------------
	ofstream	tileFile(FILE_SPRITE_TILE, ios::binary);	
	ofstream	tileIndexFile(FILE_SPRITEINDEX_TILE, ios::binary);	
	...
	//------------------------------------------------------------	
	ifstream	tileFile2(FILE_SPRITE_TILE, ios::binary);
	...
	*/
	...
	ifstream TilePackIndexFile(FILE_SPRITEINDEX_TILE, ios::binary);
...
//	DrawTitleLoading();
	...
	/* TILE INDEX 만들기
	CSpritePack spk;
	ifstream TilePackIndexFile(FILE_SPRITE_TILE, ios::binary);
	spk.LoadFromFile(TilePackIndexFile);	
	TilePackIndexFile.close();	

	ofstream TilePackIndexFile2(FILE_SPRITE_TILE, ios::binary);
	ofstream TilePackIndexFile3(FILE_SPRITEINDEX_TILE, ios::binary);
	...
	*/
	...
	/*
	ifstream	TilePackFile(FILE_SPRITE_TILE, ios::binary);		
	...
	*/
	...
	/*
	CSpritePack tempSPK;
	ifstream	ioFile2(FILE_SPRITE_IMAGEOBJECT, ios::binary);
	tempSPK.LoadFromFile(ioFile2);
	ioFile2.close();

	ofstream	ioFile(FILE_SPRITE_IMAGEOBJECT, ios::binary);	
	ofstream	ioIndexFile(FILE_SPRITEINDEX_IMAGEOBJECT, ios::binary);	
	...
	*/
	...
	ifstream ImageObjectPackIndexFile(FILE_SPRITEINDEX_IMAGEOBJECT, ios::binary);
...
//	DrawTitleLoading();
	...
	/*
	ifstream	ImageObjectPackFile(FILE_SPRITE_IMAGEOBJECT, ios::binary);		
	...
	*/
	...
	//
	//------------------------------------------------------------
	ofstream	effectFile(FILE_ASPRITE_ALPHAEFFECT, ios::binary);	
	ofstream	effectIndexFile(FILE_ASPRITEINDEX_ALPHAEFFECT, ios::binary);	
...
//	else
	{
		...
		//m_EffectAlphaSPK.LoadFromFile(effectFile2);
		//effectFile2.close();	
//		ifstream effectFileIndex;//(FILE_ISPRITEINDEX_CREATURE, ios::binary);
...
//	DrawTitleLoading();
	...
	*/
	...
	// Save  Etc SpritePack	
	//------------------------------------------------------------
	ofstream	EtcFile(FILE_SPRITE_ETC, ios::binary);	
	ofstream	EtcIndexFile(FILE_SPRITEINDEX_ETC, ios::binary);	
	...
	*/
	...
	{
		ifstream	EtcFile2;//(FILE_SPRITE_ETC, ios::binary);
...
//	{
//		ifstream	ioFile2;//(FILE_SPRITE_ETC, ios::binary);
...
//	{
//		/*
//		ifstream	ioFile3;//(FILE_SPRITE_ETC, ios::binary);
...
//	}
	...
	ofstream	NormalEffectFile(FILE_SPRITE_NORMALEFFECT, ios::binary);	
	ofstream	NormalEffectIndexFile(FILE_SPRITEINDEX_NORMALEFFECT, ios::binary);	
	...
	*/
	...
	{
//		ifstream	NormalEffectFile2;//(FILE_SPRITE_NORMALEFFECT, ios::binary);
...
//		NormalEffectFile2.close();	
	...
	{
		ifstream	WeatherFile2;//(FILE_SPRITE_WEATHER, ios::binary);
...
//	}
	...
	// Save  Minimap Sprite
	//------------------------------------------------------------	
	ofstream	MapTest1("Data\\Image\\map_a.spr", ios::binary);		
	...
	// Save  Minimap Sprite
	//------------------------------------------------------------	
	ofstream	MapTest2("Data\\Image\\map_h.spr", ios::binary);		
	...
	// Save  Minimap Sprite
	//------------------------------------------------------------	
	ofstream	MapTest3("Data\\Image\\map_e.spr", ios::binary);		
	...
	// Save  Minimap Sprite
	//------------------------------------------------------------	
	ofstream	MapTest4("Data\\Image\\map_c.spr", ios::binary);		
	...
	// Save  Minimap Sprite
	//------------------------------------------------------------	
	ofstream	MapTest5("Data\\Image\\map_d.spr", ios::binary);		
	...
	*/
	...
	{
		ifstream	guildFile2;//(FILE_SPRITE_WEATHER, ios::binary);
...
MTopView::InitFilters()
{
	...
	*/
	...
	//------------------------------------------------------------
	ofstream	FilterLight2DFile(FILE_FILTER_LIGHT2D, ios::binary);		
	...
	*/
	...
	//------------------------------------------------------------	
	//ifstream	FilterLight2DFile2(FILE_FILTER_LIGHT2D, ios::binary);
	...
	if (CDirect3D::IsHAL())
	{
		...
		//------------------------------------------------------------
		ofstream	LightFilter3DFile(FILE_FILTER_LIGHT3D, ios::binary);
		...
		*/
		...
		//------------------------------------------------------------	
		ifstream	LightFilter3DFile2;//(FILE_FILTER_LIGHT3D, ios::binary);
	...
	else
	{
		...
		// Save  Light2D FilterPack
		//------------------------------------------------------------
		ofstream	LightFilter2DFile(FILE_FILTER_LIGHT2D, ios::binary);
		...
		*/
		...
		// Load  Light2D FilterPack
		//------------------------------------------------------------	
		ifstream	LightFilter2DFile2;//(FILE_FILTER_LIGHT2D, ios::binary);
...
*/
	...
	// Save  Light3D FilterPack
	//------------------------------------------------------------
	ofstream	ImageObjectFilterFile(FILE_FILTER_IMAGEOBJECT, ios::binary);
	...
	*/
	...
	{
		ifstream	ImageObjectFilterFile2;//(FILE_FILTER_IMAGEOBJECT, ios::binary);
...
{		
	...
	ofstream packFile(FILE_CFRAME_CREATURE, ios::binary);
	ofstream indexFile(FILE_CFRAMEINDEX_CREATURE, ios::binary);
	...
	*/
	...
	///*
	// Load from File
	ifstream file;//(FILE_CFRAME_CREATURE, ios::binary);
	...
	*/
	...
	//
	//------------------------------------------------------------
	ifstream fileShadow;//(FILE_CFRAME_CREATURE, ios::binary);
	...
	*/
	...
	ifstream AdvancementOustersFile;//(FILE_CFRAME_ADDON_MALE, ios::binary);
	...
	ifstream AdvancementOustersShadowFile;//(FILE_CFRAME_ADDON_MALE, ios::binary);
	...
	ifstream NewSlayerManShadowFile;
	...
	ifstream NewSlayerWomanShadowFile;
	...
	// Load from File
	//------------------------------------------------
	ifstream AdvancementSlayerFile;//(FILE_CFRAME_ADDON_MALE, ios::binary);
	...
	ifstream AdvancementVampireFile;//(FILE_CFRAME_ADDON_MALE, ios::binary);
	...
	ifstream AdvancementSlayerShadowFile;//(FILE_CFRAME_ADDON_MALE, ios::binary);
	...
	ifstream AdvancementVampireShadowFile;//(FILE_CFRAME_ADDON_MALE, ios::binary);
...
*/
	...
	// 그림자 - Load from File
	//------------------------------------------------
	ifstream AddonShadowFile2;//(FILE_CFRAME_ADDON_MALE, ios::binary);
	...
	ifstream OustersShadowFile2;//(FILE_CFRAME_ADDON_MALE, ios::binary);
	...
	*/
	...
	ofstream packFileMale(FILE_CFRAME_ADDON_MALE, ios::binary);
	ofstream indexFileMale(FILE_CFRAMEINDEX_ADDON_MALE, ios::binary);
	m_AddonMaleFPK.SaveToFile(packFileMale, indexFileMale);	
	packFileMale.close();
	indexFileMale.close();

	ofstream packFileFemale(FILE_CFRAME_ADDON_FEMALE, ios::binary);
	ofstream indexFileFemale(FILE_CFRAMEINDEX_ADDON_FEMALE, ios::binary);
...
MTopView::InitImageFrames()
{
	...
	ofstream packFile(FILE_IFRAME_ITEMTILE, ios::binary);
	ofstream indexFile(FILE_IFRAMEINDEX_ITEMTILE, ios::binary);
	...
	*/
	...
	///*
	// Load from File
	ifstream file2;//(FILE_IFRAME_ITEMTILE, ios::binary);
...
//	
//
//	ofstream iopackFile(g_pFileDef->getProperty("FILE_AFRAME_INTERACTIONOBJECT").c_str(), ios::binary);
//	ofstream ioindexFile(g_pFileDef->getProperty("FILE_AFRAMEINDEX_INTERACTIONOBJECT").c_str(), ios::binary);
...
//#endif
	...
	///*
	// Load from File
//	ifstream iofile2;//(FILE_AFRAME_ANIMATIONOBJECT, ios::binary);
...
//	iofile2.close();
	...
	//
	//------------------------------------------------------------	
	ifstream itemdropfile2;//(FILE_AFRAME_ANIMATIONOBJECT, ios::binary);
...
//
//	}
//	ofstream itemdropfile3(g_pFileDef->getProperty("FILE_AFRAME_ITEMDROP").c_str(), ios::binary);
//	ofstream itemdropfile4(g_pFileDef->getProperty("FILE_AFRAMEINDEX_ITEMDROP").c_str(), ios::binary);
...
//	itemdropfile3.close();
	...
	// 저장
	//------------------------------------------------------------	
	ofstream packFile(FILE_AFRAME_ITEMDROP, ios::binary);
	ofstream indexFile(FILE_AFRAMEINDEX_ITEMDROP, ios::binary);
	...
	*/
	...
	ofstream packFile(g_pFileDef->getProperty("FILE_AFRAME_ITEMBROKEN").c_str(), ios::binary);
	ofstream indexFile(g_pFileDef->getProperty("FILE_AFRAMEINDEX_ITEMBROKEN").c_str(), ios::binary);
	...
	///*
	// Load from File
	ifstream fileItemBroken2;//(FILE_IFRAME_ITEMTILE, ios::binary);
...
MTopView::InitEffectFrames()
{
	...
	ofstream packNormalFile(FILE_EFRAME_NORMALEFFECT, ios::binary);
	ofstream indexNormalFile(FILE_EFRAMEINDEX_NORMALEFFECT, ios::binary);
	...
	*/
	...
	// [ TEST CODE ]
	/*
	ifstream fileFA;//(FILE_EFRAME_NORMALEFFECT, ios::binary);
	...
	*/
	...
	ifstream NormalFile2;//(FILE_EFRAME_NORMALEFFECT, ios::binary);
	...
	*/
	...
	ofstream packAlphaFile(FILE_EFRAME_ALPHAEFFECT, ios::binary);
	ofstream indexAlphaFile(FILE_EFRAMEINDEX_ALPHAEFFECT, ios::binary);
	...
	*/
	...
	///*
	// Load from AlphaFile
	ifstream AlphaFile2;//(FILE_EFRAME_ALPHAEFFECT, ios::binary);
	if (!FileOpenBinary(g_pFileDef->getProperty("FILE_EFRAME_ALPHAEFFECT").c_str(), AlphaFile2))
		return false;
	//ifstream AlphaFile2("effect.efpk", ios::binary);
...
//		
//
//		ofstream packshadowEffectFile(g_pFileDef->getProperty("FILE_EFRAME_SHADOWEFFECT").c_str(), ios::binary);
//		ofstream indexshadowEffectFile(g_pFileDef->getProperty("FILE_EFRAMEINDEX_SHADOWEFFECT").c_str(), ios::binary);
...
//	#endif
	...
	ifstream ScreenFile2;//(FILE_EFRAME_ScreenEFFECT, ios::binary);
	if (!FileOpenBinary(g_pFileDef->getProperty("FILE_EFRAME_SCREENEFFECT").c_str(), ScreenFile2))
		return false;
	//ifstream ScreenFile2("effect.efpk", ios::binary);
...
MTopView::UseHalfFrame(bool bUse)
{
	...
	{
		// 이미 Loading된 것들 제거		
		ifstream file(FILE_CFRAME_CREATURE2, ios::binary);
		m_CreatureFPK.LoadFromFile(file);
		file.close();		
	}
	else
...
//			ifstream	creatureFile;//(FILE_ISPRITE_CREATURE, ios::binary);
...
MTopView::LoadFromFileTileAndImageObjectSet(const CSpriteSetManager &TileSSM, const CSpriteSetManager &ImageObjectSSM)
{
	...
	//
	//--------------------------------------------------------
//	ifstream	TileSPKFile;//(FILE_SPRITE_TILE, ios::binary);	
...
//
	...
	//
	//--------------------------------------------------------
//	ifstream	ImageObjectSPKFile;//(FILE_SPRITE_IMAGEOBJECT, ios::binary);	
