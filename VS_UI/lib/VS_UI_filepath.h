...
//add by zdj
#define SPK_SLAYER_INVENTORY_SUB		_ROOT"spk\\XMasCard.spk"
#define SPK_VAMPIRE_INVENTORY_SUB		_ROOT"spk\\XMasCard.spk"
#define SPK_OUSTERS_INVENTORY_SUB		_ROOT"spk\\XMasCard.spk"
