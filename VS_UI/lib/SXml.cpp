...
{
	ATTRIBUTES_MAP::iterator itr = m_AttributesMap.begin();
	ATTRIBUTES_MAP::iterator endItr = m_AttributesMap.end();
	...
	CHILDREN_MAP::iterator itr2 = m_ChildrenMap.begin();
	CHILDREN_MAP::iterator endItr2 = m_ChildrenMap.end();
