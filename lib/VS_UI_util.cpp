...
//-----------------------------------------------------------------------------
void C_SPRITE_PACK::BltClip(int x, int y, Rect &rect, SPRITE_ID sprite_id) const
{
	//assert(sprite_id >= 0);
...
-
-----------------------------------------------------------------------------*/
int C_SPRITE_PACK::GetWidth(SPRITE_ID sprite_id) const
{
	//assert(sprite_id >= 0);
...
-
-----------------------------------------------------------------------------*/
int C_SPRITE_PACK::GetHeight(SPRITE_ID sprite_id) const
{
	//assert(sprite_id >= 0);
...
// sprite의 원하는 부분만 출력할 때 용이하다.
//-----------------------------------------------------------------------------
void C_SPRITE_PACK::BltLockedClip(int x, int y, Rect &rect, SPRITE_ID sprite_id) const
{
	//assert(sprite_id >= 0);
