...
// 
//-----------------------------------------------------------------------------
/*CSprite * C_VS_UI_ITEM::GetSprite(data_id_t id) const
{
...
- Item을 출력한다.
-----------------------------------------------------------------------------*/
void C_VS_UI_ITEM::Blt(POINT &point, data_id_t id)
{
//	if (p_sprite == NULL)
//	{
...
// 
//-----------------------------------------------------------------------------
void C_VS_UI_ITEM::Blt(int x, int y, data_id_t id)
{
	POINT point = {x, y};
...
// 
//-----------------------------------------------------------------------------
void C_VS_UI_ITEM::BltOutline(int x, int y, int color, data_id_t id)
{
//#ifndef _LIB
//	if (id >= ITEM_COUNT)
//		return;
...
// 
//-----------------------------------------------------------------------------
void C_VS_UI_ITEM::BltOutlineOnly(int x, int y, int color, data_id_t id)
{
//#ifndef _LIB
//	if (id >= ITEM_COUNT)
//		return;
...
//
//-----------------------------------------------------------------------------
int C_VS_UI_ITEM::GetWidth(data_id_t id)
{
//#ifndef _LIB
//	if (id >= ITEM_COUNT)
//		return 0;
...
// 
//-----------------------------------------------------------------------------
int C_VS_UI_ITEM::GetHeight(data_id_t id)
{
//#ifndef _LIB
//	if (id >= ITEM_COUNT)
//		return 0;
...
// 
//-----------------------------------------------------------------------------
//int C_VS_UI_ITEM::GetRX(data_id_t id) const
//{
...
// 
//-----------------------------------------------------------------------------
//int C_VS_UI_ITEM::GetRY(data_id_t id) const
//{
...
C_VS_UI_ITEM::C_VS_UI_ITEM()
{
	...
	int i = MItem::MAX_ITEM_CLASS;
	for (i=0; i<MItem::MAX_ITEM_CLASS; i++)
...
//	int n = 0;
	...
	for (i=0; i<MItem::MAX_ITEM_CLASS; i++)
	{
		...
		for (int t=0; t<(*g_pItemTable)[i].GetSize(); t++)
		{
			MItem * p_item = MItem::NewItem((enum MItem::ITEM_CLASS)i);
...
//*/
	...
	if (!item_ispk)
		_Error(FILE_OPEN);
	m_item_ispk.LoadFromFile(item_ispk);
	item_ispk.close();
...
// rgb 중 하나만으로 blt한다.
//-----------------------------------------------------------------------------
void C_VS_UI_ITEM::BltColor(int x, int y, data_id_t id, int rgb)
{
//#ifndef _LIB
//	if (id >= ITEM_COUNT)
//		return;
...
// rgb 중 하나만으로 blt한다.
//-----------------------------------------------------------------------------
void C_VS_UI_ITEM::BltDarkness(int x, int y, data_id_t id, int dark)
{
//#ifndef _LIB
//	if (id >= ITEM_COUNT)
//		return;
...
// ColorSet을 적용하여 출력
//-----------------------------------------------------------------------------
void C_VS_UI_ITEM::BltColorSet(int x, int y, data_id_t id, int color_set)
{
//#ifndef _LIB
//	if (id >= ITEM_COUNT)
//		return;
...
- Item을 출력한다.
-----------------------------------------------------------------------------*/
void C_VS_UI_ITEM::BltLocked(POINT &point, data_id_t id)
{
//	if (p_sprite == NULL)
//	{
//		// Item이 "없음"을 표시하기 위해서 이 Sprite를 출력한다.
...
// 
//-----------------------------------------------------------------------------
void C_VS_UI_ITEM::BltLocked(int x, int y, data_id_t id)
{
	POINT point = {x, y};
...
// 
//-----------------------------------------------------------------------------
void C_VS_UI_ITEM::BltLockedOutline(int x, int y, int color, data_id_t id)
{
//#ifndef _LIB
//	if (id >= ITEM_COUNT)
//		return;
...
// 
//-----------------------------------------------------------------------------
void C_VS_UI_ITEM::BltLockedOutlineOnly(int x, int y, int color, data_id_t id)
{
//#ifndef _LIB
//	if (id >= ITEM_COUNT)
//		return;
...
// rgb 중 하나만으로 blt한다.
//-----------------------------------------------------------------------------
void C_VS_UI_ITEM::BltLockedColor(int x, int y, data_id_t id, int rgb)
{
//#ifndef _LIB
//	if (id >= ITEM_COUNT)
//		return;
...
// rgb 중 하나만으로 blt한다.
//-----------------------------------------------------------------------------
void C_VS_UI_ITEM::BltLockedDarkness(int x, int y, data_id_t id, int dark)
{
//#ifndef _LIB
//	if (id >= ITEM_COUNT)
//		return;
...
// ColorSet을 적용하여 출력
//-----------------------------------------------------------------------------
void C_VS_UI_ITEM::BltLockedColorSet(int x, int y, data_id_t id, int color_set)
{
//#ifndef _LIB
//	if (id >= ITEM_COUNT)
//		return;
