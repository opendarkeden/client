...
public:
	...
	{
		std::string Name;
		std::vector<FRIEND_CHATTING_INFO> m_v_chatting_info;
		int blIsOnline;
		int MarkID;
	};
	std::vector<FRIEND_LIST> m_v_FriendList;
	//friend  C_VS_UI_FRIEND_INFO* This_FRIEND_INFO;
	//friend  void SetThis(C_VS_UI_FRIEND_INFO* this_friend) { This_FRIEND_INFO = this_friend; }
	void	Process();
	void	UnacquireMouseFocus(){}
	bool	IsPixel(int _x, int _y);
	void	Run(id_t id);
...
public:
	...
	std::vector<HISTORY_LIST> m_v_History_List;
	void	Process();
	void	UnacquireMouseFocus();
	bool	IsPixel(int _x, int _y);
	void	Run(id_t id);
