...
//				else
//					gpC_base->m_dialog_menu_pi.text_color = RGB(50, 50, 150);
...
//				else
//					gpC_base->m_dialog_menu_pi.text_color = RGB_BLACK;
				p_pi = &gpC_base->m_dialog_menu_pi;
			}
...
//	if(!gbl_vampire_interface)
//	{
//		gpC_base->m_dialog_msg_pi.text_color = RGB_BLACK;
//	}
	// message
...
//	if(!gbl_vampire_interface)
//	{
//		gpC_base->m_dialog_msg_pi.text_color = RGB_WHITE;
//	}
...
{
	int NowPos,i,MaxPos=m_button_y_list[m_menu_count]-m_temp_menu_rect_y-m_menu_rect.h,half;
//	BYTE Remain;
