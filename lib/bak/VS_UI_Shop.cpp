...
//	m_shop_type = pShop->GetShopType();
	...
	// Item 생성 --> 추가
	//----------------------------------------------------
	pItem = MItem::NewItem( MItem::ITEM_CLASS_RING );
	pItem->SetID( 0 );
	pItem->SetItemType( 0 );
	...
	// Item 생성 --> 추가
	//----------------------------------------------------
	pItem = MItem::NewItem( MItem::ITEM_CLASS_MAGAZINE );
	pItem->SetID( 1 );
	pItem->SetItemType( 1 );
//	pItem->SetItemOptionList( 0 );
	...
	// Item 생성 --> 추가
	//----------------------------------------------------
	pItem = MItem::NewItem( MItem::ITEM_CLASS_POTION );
	pItem->SetID( 2 );
	pItem->SetItemType( 2 );
//	pItem->SetItemOptionList( 0 );
	pItem->SetCurrentDurability( 1 );	
...
//	pItem->SetItemOptionList( 0 );
	...
	// Item 생성 --> 추가
	//----------------------------------------------------
	pItem = MItem::NewItem( MItem::ITEM_CLASS_SWORD );
	pItem->SetID( 100 );
	pItem->SetItemType( 0 );
	...
	// Item 생성 --> 추가
	//----------------------------------------------------
	pItem = MItem::NewItem( MItem::ITEM_CLASS_BRACELET );
	pItem->SetID( 100 );
	pItem->SetItemType( 0 );
	pItem->AddItemOption( 1 );
	pItem->SetCurrentDurability( 1 );	
	...
	// Item 생성 --> 추가
	//----------------------------------------------------
	pItem = MItem::NewItem( MItem::ITEM_CLASS_BLADE );
	pItem->SetID( 103 );
	pItem->SetItemType( 0 );
	pItem->AddItemOption( 3 );
	pItem->SetCurrentDurability( 1 );	
	...
	// Item 생성 --> 추가
	//----------------------------------------------------
	pItem = MItem::NewItem( MItem::ITEM_CLASS_COAT );
	pItem->SetID( 104 );
	pItem->SetItemType( 0 );
	pItem->AddItemOption( 3 );
	pItem->SetCurrentDurability( 1 );	
	...
	// Item 생성 --> 추가
	//----------------------------------------------------
	pItem = MItem::NewItem( MItem::ITEM_CLASS_TROUSER );
	pItem->SetID( 105 );
	pItem->SetItemType( 0 );
	pItem->AddItemOption( 3 );
	pItem->SetCurrentDurability( 1 );	
	...
	// Item 생성 --> 추가
	//----------------------------------------------------
	pItem = MItem::NewItem( MItem::ITEM_CLASS_SHIELD );
	pItem->SetID( 106 );
	pItem->SetItemType( 0 );
	pItem->AddItemOption( 3 );
	pItem->SetCurrentDurability( 1 );	
	...
	// Item 생성 --> 추가
	//----------------------------------------------------
	pItem = MItem::NewItem( MItem::ITEM_CLASS_BELT );
	pItem->SetID( 107 );
	pItem->SetItemType( 0 );
	pItem->AddItemOption( 3 );
	pItem->SetCurrentDurability( 1 );	
