...
public:
	C_VS_UI_CHAR_DELETE(bool bl_vampire);
	~C_VS_UI_CHAR_DELETE();
...
//	bool							m_bl_change_face;
	...
	CCreatureFramePack 		m_pC_slayer_cfpk;
	CCreatureFramePack 		m_pC_vampire_cfpk;
//	CCreatureFramePack 		m_pC_slayer_woman_cfpk;
	CIndexSpritePack 			m_pC_slayer_ispk;
//	CIndexSpritePack 			m_pC_slayer_woman_ispk;
	CIndexSpritePack 			m_pC_vampire_ispk;
