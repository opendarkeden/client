...
typedef unsigned long SPRITE_ID;
...
public:
	...
	void	BltClip(int x, int y, Rect &rect, SPRITE_ID sprite_id=0) const;

	int		GetWidth(SPRITE_ID sprite_id = 0) const;
	int		GetHeight(SPRITE_ID sprite_id = 0) const;
	...
	void	BltLockedClip(int x, int y, Rect &rect, SPRITE_ID sprite_id=0) const;
