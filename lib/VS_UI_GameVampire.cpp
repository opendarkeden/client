...
void C_VS_UI_VAMPIRE::HotKey_F1()
{
	...
	const MItem * p_item = g_pInventory->FindItem( MItem::ITEM_CLASS_SERUM );
...
C_VS_UI_VAMPIRE_GEAR::C_VS_UI_VAMPIRE_GEAR()
{
	...
	m_slot_rect[SN_NECKLACE].Set(99, 14, 30, 30);
	m_slot_rect[SN_COAT].Set(84, 49, 60, 90);
	m_slot_rect[SN_BRACELET1].Set(45, 109, 30, 30);
	m_slot_rect[SN_BRACELET2].Set(153, 109, 30, 30);
	m_slot_rect[SN_RING1].Set(45, 144, 30, 30);
	m_slot_rect[SN_RING2].Set(81, 144, 30, 30);
	m_slot_rect[SN_RING3].Set(117, 144, 30, 30);
	m_slot_rect[SN_RING4].Set(153, 144, 30, 30);
	m_slot_rect[SN_EARRING1].Set(48, 14, 30, 30);
	m_slot_rect[SN_EARRING2].Set(150, 14, 30, 30);
	m_slot_rect[SN_LEFTHAND].Set(17, 46, 60, 60);
	m_slot_rect[SN_RIGHTHAND].Set(150, 46, 60, 60);
	m_slot_rect[SN_AMULET1].Set(45, 178, 30, 30);
	m_slot_rect[SN_AMULET2].Set(81, 178, 30, 30);
	m_slot_rect[SN_AMULET3].Set(117, 178, 30, 30);
	m_slot_rect[SN_AMULET4].Set(153, 178, 30, 30);
